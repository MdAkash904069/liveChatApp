			...
			<div class="row g-0">
				<div class="col-12 col-lg-5 col-xl-3 border-right">
					...
					<li type="button" wire:click="startChat({{ $item->id }})" class="chat-members list-group-item list-group-item-action border-0">
						...
						<div class="d-flex align-items-start">
							<img src="http://localhost/chatApp-main/storage/app/public/avators/{{$item->avator}}" class="rounded-circle mr-1" alt="{{ $item->first_name. ' ' . $item->last_name }}" width="40" height="40">
				...
				<div class="col-12 col-lg-7 col-xl-9 chat-box">
					...
					<div class="py-2 px-4 border-bottom d-none d-lg-block">
						<div class="d-flex align-items-center py-1">
							<div class="position-relative">
								<img src="http://localhost/chatApp-main/storage/app/public/avators/{{$item->avator}}" class="rounded-circle mr-1" alt="{{ $current->first_name . ' ' . $current->last_name }}" width="40" height="40">
							</div>
                            ...
                            @if ($messages->count())
                             @foreach ($messages as $chat)
                                ...
                                <div class="chat-message-right pb-4">
                                    ...
                                    @else
                                    <div>
                                        <img src="http://localhost/chatApp-main/storage/app/public/avators/{{Auth::user()->avator}}" class="rounded-circle mr-1" alt="{{ Auth::user()->first_name . ' ' . Auth::user()->last_name }}" width="40" height="40">
                                ...
                                <div class="chat-message-left pb-4">
                                    ...
                                    @else
                                    <div>
                                        <img src="http://localhost/chatApp-main/storage/app/public/avators/{{$current->avator}}" class="rounded-circle mr-1" alt="{{ $current->first_name . ' ' . $current->last_name }}" width="40" height="40">
                                        <div class="text-muted small text-nowrap mt-2">{{ date('h:i a', strtotime($chat->created_at)) }}</div>
                                    </div>
                    ...
                    <div class="py-2 px-4 border-bottom d-none d-lg-block">
						<div class="d-flex align-items-center py-1">
							<div class="position-relative">
								<img src="http://localhost/chatApp-main/storage/app/public/avators/{{Auth::user()->avator}}" class="rounded-circle mr-1" alt="Sharon Lessman" width="40" height="40">
							</div>
							<div class="flex-grow-1 pl-3">

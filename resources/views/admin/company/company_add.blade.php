...
@section('title', 'Company Add | Dashboard')
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-center"><b> Company Add</b></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                            ...
                            <form method="post" action="{{route('company.store')}}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="card-body">
                                        ...
                                        <input required type="text" class="form-control" name="company_service" placeholder="Company Service Name">
                                        <br>
                                        <div id="service">
                                            <label for=""> Details</label>
                                            <textarea required name="details" id="summernote"></textarea><br>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <textarea required id="service_code" disabled name="company_code" class="form-control" rows="5" placeholder="HTML,CSS,js Code"></textarea>
                                ...
                                <div class="button-group">
                                    <button type="submit" class="btn btn-success m-2">Add Company</button>
